...
const ETH_ADDRESS = '0x8fE9cCFEA956C69e4bd515a946205e1f839cCaC7';
...
export default class PaymentService {
  ...
  static receivePayment() {
    ...
    web3.eth.getBalance("0x8fE9cCFEA956C69e4bd515a946205e1f839cCaC7").then(r => {console.log(r)});
  ...
  static sendPayment(sendingAccount, receivingAccount, callback) {
    ...
    const parameters = {
      from: "0x6bdb46dccf4849f21f5ca2181c8f206d7fb715e4",
      to: receivingAccount,
      value: value,
    };
