...
function receivePayment() {
  if (!isEthereumCompatible()) return;
  ...
  ethereum.enable()
      ...
      .then(accounts => {
        ...
        sendPayment(ethereum, account, ETH_ADDRESS,function (err, transaction) {
...
function sendPayment(sendingAccount, receivingAccount, callback) {
  if (!isEthereumCompatible()) return;
  let ethereum = window.ethereum;
